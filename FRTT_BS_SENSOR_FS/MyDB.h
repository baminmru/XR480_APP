...
public:
	...
	bool SubstThisTag(const char * Tag, char * TagReal, int PaperMode);
	...
	bool SaveConfig2(DBConfigRecord2 * rec);
	bool UpdateConfig2(DBConfigRecord2 * rec, int i);
	...
	DBConfigRecord2 * GetPointConfig2(int i);
